...
The cointegration and causality diagnostics support a cautious interpretation of the core transmission results. The bivariate Engle--Granger test for world cocoa and Colombian cocoa does not reject the null of no cointegration in the imputed aligned sample ($p=0.132$). By contrast, the short-run evidence is stronger: Granger causality from world cocoa returns to Colombian cocoa returns is strongest at lag 3 ($p=0.023$), and the compact return VAR selects lag order 1. Taken together, these results suggest that short-run transmission is better supported than strong long-run equilibrium claims in the current sample.
